  ...
  return (
    <header className="w-full fixed h-16 z-1000 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 shadow-sm py-9">
      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        <div className="md:flex items-center gap-3 pl-4 border-l hidden border-gray-200 group cursor-pointer hover:bg-blue-50 rounded-lg px-3 py-2 transition">
          <div className="relative">
            <FaUserCircle className="text-gray-500 group-hover:text-blue-600 text-2xl transition" />
