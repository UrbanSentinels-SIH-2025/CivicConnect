...
import DepartmentSidebar from "../DepartmentDashboard.jsx/DepartmentSidebar";
import DepartmentTopbar from "../DepartmentDashboard.jsx/DepartmentTopbar";
export default function DepartmentsLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-gray-100 overflow-hidden relative">
      {/* Top Navigation Bar */}
      <DepartmentTopbar  onMenuClick={toggleSidebar} isSidebarOpen={isSidebarOpen} />

      <div className="flex flex-1 pt-18 overflow-hidden">
        <DepartmentSidebar isSidebarOpen={isSidebarOpen} onMenuClick={toggleSidebar} />
